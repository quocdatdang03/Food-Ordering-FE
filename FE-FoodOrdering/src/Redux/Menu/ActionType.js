...
export const GET_MENU_ITEM_OF_CURRENT_RESTAURANT_BY_ID_REQUEST =
  "GET_MENU_ITEM_OF_CURRENT_RESTAURANT_BY_ID_REQUEST;";
export const GET_MENU_ITEM_OF_CURRENT_RESTAURANT_BY_ID_SUCCESS =
  "GET_MENU_ITEM_OF_CURRENT_RESTAURANT_BY_ID_SUCCESS";
export const GET_MENU_ITEM_OF_CURRENT_RESTAURANT_BY_ID_FAILURE =
...
export const UPDATE_MENU_ITEM_AVAILABLE_REQUEST =
  "UPDATE_MENU_ITEM_AVAILABLE_REQUEST";
export const UPDATE_MENU_ITEM_AVAILABLE_SUCCESS =
  "UPDATE_MENU_ITEM_AVAILABLE_SUCCESS";
export const UPDATE_MENU_ITEM_AVAILABLE_FAILURE =
